...
\begin{center}
    \begin{tikzpicture}
       ...
       \node[anchor=east] at (5,-2) (prior) {};
       \node[anchor=east] at (3,0) (start) {};
       \node[anchor=west] at (3,3) (end) {};
       \draw (start) edge[out=90,in=0, densely dotted, ->] (end) edge[out=-90,in=90, densely dotted, ->] (init);
    \end{tikzpicture}
